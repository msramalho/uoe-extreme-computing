cat ../data/small/imdb/title.basics.tsv ../data/small/imdb/title.ratings.tsv | shuf | ./mapper_1.py | sort -t'|' -k1 | ./reducer_1.py | cat | sort -t '|' -k1,3 | ./reducer_2.py > result.txt
